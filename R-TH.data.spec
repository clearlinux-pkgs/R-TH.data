...
Version  : 1.0.7
Release  : 5
URL      : https://cran.r-project.org/src/contrib/Archive/TH.data/TH.data_1.0-7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Archive/TH.data/TH.data_1.0-7.tar.gz
...
%build
export LANG=C
export SOURCE_DATE_EPOCH=1489187476
